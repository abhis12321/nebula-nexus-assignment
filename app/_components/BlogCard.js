...
export default function BlogCard({ blog }) {
    ...
    return (
        <div className='ring-2 bg-blue-900/10 px-2 sm:px-3 pt-2 pb-3 rounded w-[98%] max-w-[400px] flex flex-col items-start justify-start relative'>
            <div className="absolute bottom-1 left-3 px-2 py-1 rounded cursor-pointer font-semibold text-red-950 hover:bg-gray-700/20 text-xs bg-gray-700/10 shadow-[0_0_2px_gray]" onClick={copyURL}>share</div>
